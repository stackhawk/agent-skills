...
*replaces* the forced BOLA/BFLA-only preset with this policy. If these IDs are missing, the
scan silently performs no authorization testing at all. hawkscan trusts this guarantee and
does not re-read the policy to check.
