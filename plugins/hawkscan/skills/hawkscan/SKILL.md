...
4. **Scan:** Run `hawk scan --json-output` and parse the structured findings. Note the current
   commit SHA (`git rev-parse --short HEAD`) — scan results are associated with this commit.
5. **If findings exist:**
