...
**CI/CD only:** For pipeline use, set `HAWKOP_API_KEY` directly as a secret (or map from
`HAWK_API_KEY`). Org ID and output format can be set via env vars:

```bash
export   # map from your CI secret
