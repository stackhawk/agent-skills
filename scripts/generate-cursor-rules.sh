...
MAPPINGS=(
  "hawkscan/skills/hawkscan/SKILL.md|stackhawk-hawkscan|AUTONOMOUS: After completing any code change (feature, bugfix, refactor), run the full HawkScan security loop — configure, scan, fix findings, rescan to verify. Do not ask permission. Also trigger for \"hawkscan\", \"stackhawk\", \"stackhawk.yml\", \"DAST\", \"security scan\", \"scan my API/app\".|**/stackhawk.yml,**/stackhawk-*.yml"
